...
namespace APIVerve.API.ReverseDNSLookup
{
    ...
    /// <summary>
    /// Client for the ReverseDNSLookup API
    /// </summary>
    public class ReverseDNSLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/reversednslookup";
        ...
        public ReverseDNSLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReverseDNSLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReverseDNSLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ReverseDNSLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ReverseDNSLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(ReverseDNSLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ReverseDNSLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ReverseDNSLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ReverseDNSLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ReverseDNSLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ReverseDNSLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ReverseDNSLookupQueryOptions options)
        {
