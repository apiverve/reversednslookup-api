# Reverse DNS Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:reversednslookup-api:1.1.14'
}
```
...
```java
import com.apiverve.reversednslookup.ReverseDNSLookupAPIClient;
import com.apiverve.reversednslookup.APIResponse;
import com.apiverve.reversednslookup.APIException;

// Initialize the client
ReverseDNSLookupAPIClient client = new ReverseDNSLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ip", "8.8.8.8");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/reversednslookup](https://docs.apiverve.com/ref/reversednslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/reversednslookup](https://docs.apiverve.com/ref/reversednslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/reversednslookup-api/issues)
