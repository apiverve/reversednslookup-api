// Package reversednslookup provides a Go client for the Reverse DNS Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/reversednslookup?utm_source=go&utm_medium=readme
package reversednslookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/reversednslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Reverse DNS Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Reverse DNS Lookup API client.
...
// Execute makes a request to the Reverse DNS Lookup API with typed parameters.
//
...
//   - ip (required): string - The IP address to lookup (IPv4 or IPv6) [format: ip]
